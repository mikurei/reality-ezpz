...
image[sing-box]="gzxhwq/sing-box:v1.5.0-beta.4"
...
function download_tgbot_script {
  curl -fsSL https://raw.githubusercontent.com/mikurei/reality-ezpz/master/tgbot.py -o "${path[tgbot_script]}"
}
